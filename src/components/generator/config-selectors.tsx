  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`w-full text-left bg-[var(--surface-2)] rounded-[var(--radius-md)] px-3.5 py-2.5 transition-all cursor-pointer border border-transparent ${
          open
            ? 'bg-[var(--surface-3)] border-[var(--accent)]/50'
      ...
      {open && (
        <div
          className="absolute z-50 top-full left-0 right-0 mt-1 bg-[var(--surface)] rounded-[var(--radius-md)] py-1 max-h-[220px] overflow-y-auto border border-[var(--border)]"
    ...
    <div className="space-y-2 mb-3.5">
      ...
      {endpointId === 'custom' && (
        <input
          ...
          className="w-full h-10 bg-[var(--surface-2)] rounded-[var(--radius-md)] px-3.5 text-[13px] text-[var(--text)] placeholder:text-[var(--text-dim)] outline-none focus:bg-[var(--surface-3)] focus:border-[var(--accent)] border border-transparent transition-colors"
        />
      )}
